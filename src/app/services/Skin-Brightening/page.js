        ...
        <>
            ...
            <section className="pb-5">
                <div className="container">
                    ...
                    <p>After consulting with both the Dermatologist you decide on the option that you want based on your health, requirements and financial position- you can go for the procedure.</p>
                    <p>You need to plan out the recovery time after you complete your treatment; laser treatments and chemical peels take a few days. After treatment, you need to take care of your skin by using certain maintenance products. Sunscreen is very important to prevent you from getting sunburns and also lower chances of your skin getting darker.</p>
