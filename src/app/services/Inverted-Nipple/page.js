        ...
        <>
                ...
                <div className="container">
                    <div className="row">
                        <div className="col-12 col-md-6 d-flex justify-content-center align-items-center">
                            <img className='img-fluid shadow rounded mb-3' src="..\Assets\service-imgs\Inverted_Nipple.png" alt="about image" height={300}/>
                        </div>
                        <div className="col-12 col-md-6 d-flex justify-content-center align-items-center">
                            <div className="about">
            ...
            <section className='pb-5'>
                <div className="container">
                    ...
                    <p>Your doctor will evaluate your case and recommend the course of treatment. Treatments may vary depending on the degree of nipple inversion. If surgical nipple plastic surgery is required, it may be combined with breast augmentation, a breast lift, or done on its own.</p>
                    ...
                    <ul style={{ listStyleType: 'none' }}>
                        ...
                        <li><b>Grade II.</b> Nipples can be pulled out, but it is more complicated to achieve than in the first degree of inversion. In addition, the nipple does not maintain its shape and tends to retract. Breastfeeding is possible with the second degree of nipple inversion, but it is more complicated due to damaged milk ducts.</li>
                        <li><b>Grade III.</b> Nipples are severely inverted, and the only way to pull them out is with the help of a plastic reconstructive surgeon. With grade III inversion, breastfeeding is not achievable. The nipple area is often itchy, and infections may occur frequently.</li>
                    </ul>
                    <p><b>Important</b> The operation cannot be performed if the patient suffers from severe breast disease.</p>
