...
<div class="tab-content" id="pills-tabContent">
  ...
  <div className="container">
                <div className="row">
                    ...
                    <div className='col-md-4 col-12 py-3 d-flex justify-content-center align-items-center'>
                    <img
                        src="/Tummy Tuck/Tummy Tuck 2.webp"
                        class="img-fluid rounded"
                        alt="result"
                     />
                    </div>
                    <div className='col-md-4 col-12 py-3 d-flex justify-content-center align-items-center'>
                    <img
                        src="/Tummy Tuck/Tummy Tuck 3.webp"
                        class="img-fluid rounded"
                        alt="result"
                     />
                    </div>
                    <div className='col-md-4 col-12 py-3 d-flex justify-content-center align-items-center'>
                    <img
                        src="/Tummy Tuck/Tummy Tuck 4.webp"
                        class="img-fluid rounded"
                        alt="result"
                     />
                    </div>
                    <div className='col-md-4 col-12 py-3 d-flex justify-content-center align-items-center'>
                    <img
                        src="/Tummy Tuck/Tummy Tuck 5.webp"
                        class="img-fluid rounded"
                        alt="result"
                     />
                    </div>
                    <div className='col-md-4 col-12 py-3 d-flex justify-content-center align-items-center'>
                    <img
                        src="/Tummy Tuck/Tummy Tuck 6.webp"
                        class="img-fluid rounded"
                        alt="result"
                     />
                    </div>
                    <div className='col-md-4 col-12 py-3 d-flex justify-content-center align-items-center'>
                    <img
                        src="/Tummy Tuck/Tummy Tuck 7.webp"
                        class="img-fluid rounded"
                        alt="result"
                     />
                    </div>
