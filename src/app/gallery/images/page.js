...
const Images = () => {
  ...
  const categories = {
    "Hair Transplant": ["Vishal.jpg", "Amey.jpg", "Ankur Anand.jpg", "Araj.jpg", "Bhagyesh.jpg", 
    "Chirag.jpg", "Diensh.jpg", "Female.jpg", "ganesh.jpg"
    ],
              ...
              {selectedCategory && (
               ...
               {lightboxOpen && (
                            <Lightbox
                                ...
                                slides={categories[selectedCategory].map((image) => ({ src:`/HT/${image}`}))}
