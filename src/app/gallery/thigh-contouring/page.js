...
<div class="tab-content" id="pills-tabContent">
  ...
  <div className="container">
                <div className="row">
                    ...
                    <div className='col-md-4 col-12 py-3 d-flex justify-content-center align-items-center'>
                    <img
                        src="/Thigh Liposuction/Thigh Liposuction 2.webp"
                        class="img-fluid rounded"
                        alt="result"
                     />
                    </div>
                    <div className='col-md-4 col-12 py-3 d-flex justify-content-center align-items-center'>
                    <img
                        src="/Thigh Liposuction/Thigh Liposuction 3.webp"
                        class="img-fluid rounded"
                        alt="result"
                     />
                    </div>
                    <div className='col-md-4 col-12 py-3 d-flex justify-content-center align-items-center'>
                    <img
                        src="/Thigh Liposuction/Thigh Liposuction 4.webp"
                        class="img-fluid rounded"
                        alt="result"
                     />
                    </div>
                    <div className='col-md-4 col-12 py-3 d-flex justify-content-center align-items-center'>
                    <img
                        src="/Thigh Liposuction/Thigh Liposuction 5.webp"
                        class="img-fluid rounded"
                        alt="result"
                     />
                    </div>
