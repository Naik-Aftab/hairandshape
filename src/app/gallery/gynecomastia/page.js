...
<div class="tab-content" id="pills-tabContent">
  ...
  <div className="container">
                <div className="row">
                    ...
                    <div className='col-md-4 col-12 py-3 d-flex justify-content-center align-items-center'>
                    <img
                        src="/Gynecomastia/Gynecomastia 2.webp"
                        class="img-fluid rounded"
                        alt="result"
                     />
                    </div>
                    <div className='col-md-4 col-12 py-3 d-flex justify-content-center align-items-center'>
                    <img
                        src="/Gynecomastia/Gynecomastia 3.webp"
                        class="img-fluid rounded"
                        alt="result"
                     />
                    </div>
                    <div className='col-md-4 col-12 py-3 d-flex justify-content-center align-items-center'>
                    <img
                        src="/Gynecomastia/Gynecomastia 4.webp"
                        class="img-fluid rounded"
                        alt="result"
                     />
                    </div>
                    <div className='col-md-4 col-12 py-3 d-flex justify-content-center align-items-center'>
                    <img
                        src="/Gynecomastia/Gynecomastia 5.webp"
                        class="img-fluid rounded"
                        alt="result"
                     />
                    </div>
                    <div className='col-md-4 col-12 py-3 d-flex justify-content-center align-items-center'>
                    <img
                        src="/Gynecomastia/Gynecomastia 6.webp"
                        class="img-fluid rounded"
                        alt="result"
                     />
                    </div>
                    <div className='col-md-4 col-12 py-3 d-flex justify-content-center align-items-center'>
                    <img
                        src="/Gynecomastia/Gynecomastia 7.webp"
                        class="img-fluid rounded"
                        alt="result"
                     />
                    </div>
                    <div className='col-md-4 col-12 py-3 d-flex justify-content-center align-items-center'>
                    <img
                        src="/Gynecomastia/Gynecomastia 8.webp"
                        class="img-fluid rounded"
                        alt="result"
                     />
                    </div>
                    <div className='col-md-4 col-12 py-3 d-flex justify-content-center align-items-center'>
                    <img
                        src="/Gynecomastia/Gynecomastia 9.webp"
                        class="img-fluid rounded"
                        alt="result"
                     />
                    </div>
                    <div className='col-md-4 col-12 py-3 d-flex justify-content-center align-items-center'>
                    <img
                        src="/Gynecomastia/Gynecomastia 10.webp"
                        class="img-fluid rounded"
                        alt="result"
                     />
                    </div>
